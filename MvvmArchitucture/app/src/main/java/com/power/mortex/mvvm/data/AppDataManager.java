...
import com.power.mortex.mvvm.data.model.api.login.LoginRequest;
...
import com.power.mortex.mvvm.data.remote.ApiHeader;
...
//    }
    ...
    @Override
    public Single<VerifyPinResponse> verifyPinApiCall(VerifyPinRequest.VerifyPin request) {
        return mApiHelper.verifyPinApiCall(request);
    }
    ...
    public Boolean getHasSeenIntro() {
        return mPreferencesHelper.getHasSeenIntro();
    }

    @Override
    public void setHasSeenIntro(Boolean seen) {
        mPreferencesHelper.setHasSeenIntro(seen);
    }
